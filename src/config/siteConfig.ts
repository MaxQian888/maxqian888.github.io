...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://maxqian888.github.io",

	// 站点描述
	description:
		"曼波（Max Qian）的个人博客，记录 C++、编程工具、AI 与技术教程的学习笔记与分享，专注于把折腾过的技术沉淀成清晰易懂的内容。",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/element.png",
			alt: "🍀",
		},
		// 导航栏标题
		title: "曼波's Blog",
