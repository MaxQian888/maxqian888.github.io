...
🚀 クイックガイド：
[**🖥️ライブデモ**](https://maxqian888.github.io/) /
[**📝ドキュメント**](https://maxqian888.github.io/) /
[**🍀私のブログ**](https://maxqian888.github.io)
...
>
>**レイアウト設定とデモの詳細については、[Firefly レイアウトシステム詳解](https://maxqian888.github.io/posts/firefly-layout-system/)をご覧ください**
>
>Firefly は i18n の多言語 UI をサポートしていますが、簡体字中国語以外の言語は AI 翻訳です。誤りがある場合は、[Pull Request](https://github.com/MaxQian888/maxqian888.github.io/pulls) の提出を歓迎します。
...
便利な機能や最適化があれば、[Pull Request](https://github.com/MaxQian888/maxqian888.github.io/pulls)を提出してください
...
1. **リポジトリのクローン：**
   ...
   **まず自分のリポジトリに[Fork](https://github.com/MaxQian888/maxqian888.github.io/fork)してからクローン（推奨）。クローンする前にStarをクリックするのを忘れずに！**
...
> 📚 **詳細な設定ドキュメント**：[Fireflyドキュメント](https://maxqian888.github.io/)で完全な設定ガイドを確認してください
...
- Admonitions（予告ブロック） - GitHub、Obsidian、VitePressの3つのテーマ設定をサポート ([プレビューと使用方法](https://maxqian888.github.io/posts/markdown-extended/))
- GitHubリポジトリカード ([プレビューと使用方法](https://maxqian888.github.io/posts/markdown-extended/))
- Expressive Codeベースの強化コードブロック ([プレビュー](http://maxqian888.github.io/posts/code-examples/) / [ドキュメント](https://expressive-code.com/))
...
このプロジェクトに貢献してくれた以下の貢献者に感謝します。質問や提案がある場合は、[Issue](https://github.com/MaxQian888/maxqian888.github.io/issues)または[Pull Request](https://github.com/MaxQian888/maxqian888.github.io/pulls)を提出してください。
