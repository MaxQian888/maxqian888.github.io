...
🚀 快速指南：
[**🖥️線上預覽**](https://maxqian888.github.io/) /
[**📝使用文檔**](https://maxqian888.github.io/) /
[**🍀我的部落格**](https://maxqian888.github.io) 
...
>
>**更多版面配置及示範請查看：[Firefly 版面配置系統詳解](https://maxqian888.github.io/posts/firefly-layout-system/)**
>
>Firefly 支援 i18n 多語言 UI，但除了簡體中文，其他語言均為 AI 翻譯轉換，如有錯誤，歡迎提交 [Pull Request](https://github.com/MaxQian888/maxqian888.github.io/pulls) 修正。
...
如果你有好用的功能和優化，請提交 [Pull Request](https://github.com/MaxQian888/maxqian888.github.io/pulls)
...
1. **克隆儲存庫：**
   ...
   **先 [Fork](https://github.com/MaxQian888/maxqian888.github.io/fork) 到自己儲存庫再克隆（推薦），記得先點 Star 再 Fork 哦！**
...
> 📚 **詳細配置文檔**: 查看 [Firefly使用文檔](https://maxqian888.github.io/) 獲取完整的配置指南
...
- 提醒塊（Admonitions） - 支援 GitHub, Obsidian, VitePress 三種風格主題配置 ([預覽和用法](https://maxqian888.github.io/posts/markdown-extended/))
- GitHub 儲存庫卡片 ([預覽和用法](https://maxqian888.github.io/posts/markdown-extended/))
- 基於 Expressive Code 的增強程式碼區塊 ([預覽](http://maxqian888.github.io/posts/code-examples/) / [文檔](https://expressive-code.com/))
## 🧞 指令
...
感謝以下貢獻者對本專案做出的貢獻，如有問題或建議，請提交 [Issue](https://github.com/MaxQian888/maxqian888.github.io/issues) 或 [Pull Request](https://github.com/MaxQian888/maxqian888.github.io/pulls)。
